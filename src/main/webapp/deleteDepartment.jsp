...
<div class="w3-container w3-padding">
    <%
        boolean execute = Boolean.parseBoolean(String.valueOf(request.getAttribute("isDelete")));
        if (execute == true && request.getAttribute("id") != null) {
            out.println("<div class=\"w3-panel w3-green w3-display-container w3-card-4 w3-round\">\n" +
                    "   <span onclick=\"this.parentElement.style.display='none'\"\n" +
                    "   class=\"w3-button w3-margin-right w3-display-right w3-round-large w3-hover-green w3-border w3-border-green w3-hover-border-grey\">×</span>\n" +
                    "   <h5>Department with id: " + request.getAttribute("id") + " deleted!" +
                    "</div>");
        }
        if (execute== false && request.getAttribute("id") != null){
            out.println("<div class=\"w3-panel w3-green w3-display-container w3-card-4 w3-round\">\n" +
                    "   <span onclick=\"this.parentElement.style.display='none'\"\n" +
                    "   class=\"w3-button w3-margin-right w3-display-right w3-round-large w3-hover-green w3-border w3-border-green w3-hover-border-grey\">×</span>\n" +
                    "   <h5>Department with id: " + request.getAttribute("id") + " not found!" +
                    "</div>");
        }
    %>
    <div class="w3-card-4">
