  ...
  <div class="w3-card-4">
    ...
    <div class="w3-container w3-padding">
      <%
        ...
        if (d != null && request.getAttribute("id") != null) {
          out.println("<div class=\"w3-panel w3-green w3-display-container w3-card-4 w3-round\">\n" +
                  "   <span onclick=\"this.parentElement.style.display='none'\"\n" +
                  "   class=\"w3-button w3-margin-right w3-display-right w3-round-large w3-hover-green w3-border w3-border-green w3-hover-border-grey\">×</span>\n" +
                  "   <h5>id: " + d.getId() + ", " + d.getName() + "</div>");
        }
        else if (request.getAttribute("id") != null)
        out.println("<div class=\"w3-panel w3-green w3-display-container w3-card-4 w3-round\">\n" +
                "   <span onclick=\"this.parentElement.style.display='none'\"\n" +
                "   class=\"w3-button w3-margin-right w3-display-right w3-round-large w3-hover-green w3-border w3-border-green w3-hover-border-grey\">×</span>\n" +
                "   <h5>There are no department with id: " + request.getAttribute("id") + "!</h5>\n" +
                "</div>");
      %>
    ...
    <form method="post" class="w3-selection w3-light-grey w3-padding">
      ...
      <button type="submit" class="w3-btn w3-green w3-round-large w3-margin-bottom">Get</button>
    </form>
  </div>
</div>
